...
{text}"""
    ...
    if settings.enable_video_handler:
        ...
        application.add_handler(MessageHandler(filters.VIDEO_NOTE, bot_handlers.video_note_message_handler))
        logger.info("Video handler enabled (including video notes/circles)")
    else:
