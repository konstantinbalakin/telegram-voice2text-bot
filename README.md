...
Сервис для транскрибации голосовых сообщений и интеллектуальной обработки текста с помощью AI.
...
- ✅ **Платежи** - карта РФ / СБП через YooKassa (чеки 54-ФЗ)
...
- **Подписки Pro**:
  ...
  - Месяц (30 мин/день) - 180 ₽
  - Год (30 мин/день) - 1500 ₽
- **Пакеты минут**: 50/100/500/5000 минут (от 100 ₽)
- **Экран баланса**: просмотр дневного лимита, бонусных и пакетных минут
- **История платежей**: полный список покупок и подписок
...
- [YooKassa](https://yookassa.ru/) - за платежный шлюз (карты РФ, СБП, чеки 54-ФЗ)
